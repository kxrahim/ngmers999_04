                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 page-header">
                            <div class="page-pretitle">Statistic</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        for ($a=0; $a<10; ++$a){
                                                            ...
                                                            $nSession = getAssessmentCompleted2($conn, $ids, $actid);
                                                    ...
                                                    ?>
                                                        <td style="background-color: <?=$bgColor?>; text-align:center; font-weight: bolder;"><?=$nSession?></td>
                                                    <?php
                                                        }
                                                    ?>
                                                </tr>
