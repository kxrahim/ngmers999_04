                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 page-header">
                            ...
                            <h2 class="page-title">Assessment Reflection</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-md-12 col-lg-12 mt-3">
                            ...
                            <a class="btn btn-secondary" href="admin-report-supervisor.php">
                                << Back to Supervisor Report
                            </a>
                        </div>
                        
                        <div class="col-md-12 col-lg-12 mt-3">
                            <div class="card">
                                <div class="card-header">List of Assessment Reflection</div>
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover table-striped" id="dataTables-example" width="100%">
                                        <thead>
                                            <tr>
                                                <th>STUDENT NAME</th>
                                                <th>ASSESSMENT</th>
                                                <th class="text-left">Reflection on dental aspects</th>
                                                <th class="text-left">Reflection on professionalism</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                $sq1 = "SELECT *, a.id as aid
                                                        ...
                                                        WHERE a.assessor_id = '$cid' and a.reflection_id > 0
                                                        ORDER BY a.id ASC";
                                                $rs1 = $conn->query($sq1);
                                            ...
                                            <tr>                                                
                                                <td class="">
                                                    <?=$rw1['fullname']?>
                                                    <br>[<?=getCohort($conn, $rw1['cohort_id'])?>]
                                                </td>
                                                <td class=""><?=$rw1['activity']?></td>
                                                <td class="text-left"><?=$rw2['dentalAspect']?></td>
                                                <td class="text-left"><?=$rw2['professionalism']?></td>
                                            </tr>
                                            <?php   } // close while
                                                } // close num
                                            ?>
