...
//            }
            ...
            if ($_GET['assessor_id'] > 0){
                $conditions .= ' and id = ' . $_GET['assessor_id'];
            }
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 page-header">
                            ...
                            <h2 class="page-title"> Supervisor Engagement </h2>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form action="" method="get">
                                        <!-- <div class="col-lg-12 mb-3">
                                            <label for="" class="mb-2">Supervisor Name / Email</label>
                        ...
                        <div class="col-md-12 col-lg-12 mt-3">
                            <div class="card">
                                <div class="card-header">List of available Assessor</div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                while ($rw1 = $rs1->fetch_assoc()){
                                                    ...
                                                    $sn2 = "SELECT * 
                                                            FROM assessments 
                                                            WHERE assessor_id = '$assId' AND feedback_id > 0";
                                                    $rsn2 = $conn->query($sn2);
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-open rounded-0 nav-link" data-toggle="collapse" data-action="opensearch" href="report-supervisor-feedback.php?id=<?=$assId?>" role="button" aria-expanded="false" aria-controls="searchform-navbar" title="View feedback" target="_blank">
                                                        <i class="icon fa fa-search fa-fw " aria-hidden="true"></i>
                                                    </a>
                                                </td>
                                                <td class="text-center">
                                                    <a class="btn btn-open rounded-0 nav-link" data-toggle="collapse" data-action="opensearch" href="report-supervisor-reflection.php?id=<?=$assId?>" role="button" aria-expanded="false" aria-controls="searchform-navbar" title="View reflection">
